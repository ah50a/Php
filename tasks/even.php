...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    # code...
    if ($_POST['checkNumber'] % 2 == 0) {
        # code...
        $massage =  "<div class='alert alert-success'>
        <ul>
            <li>This Number is EVEN</li>
        </ul>
    </div>";
    }else {
        # code...
            ...
            <div class="col-4 offset-4 mt-3">
                <form method="post">
                    <div class="form-group">
                        <input type="number" name="checkNumber" class="form-control" placeholder="Enter Number">
                    </div>
